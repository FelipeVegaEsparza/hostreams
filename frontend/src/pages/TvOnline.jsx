    ...
    <div className="bg-gray-900 text-white">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12">La Plataforma Definitiva para Video</h2>
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-blue-900 to-gray-900">
        <div className="container mx-auto text-center">
          <h2 className="text-5xl font-extrabold mb-16 text-white">Transmite con la potencia de VDOPanel</h2>
      ...
      <section className="py-20 px-4 bg-gray-800/50">
        <div className="container mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12">Planes de TV Online</h2>
